/**
 * Creates the GpaRequirements table in the MySQL database, if it doesn't exist.
 * Every record represents the GPA requirements (i.e. there exists a minumum cumulative 
 * gpa requirement) for a Degree on a specific track.
 * a specific track. 
