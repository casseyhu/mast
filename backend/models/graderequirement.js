/**
 * Creates the GradeRequirements table in the MySQL database, if it doesn't exist.
 * Every record represents the grade requirement for a Degree on a specific track.
